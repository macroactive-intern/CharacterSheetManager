    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('characters.update', $character) }}" class="space-y-6 p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="level" name="level" type="number" min="1" max="100" class="mt-1 block w-full" :value="old('level', $character->level)" required />
